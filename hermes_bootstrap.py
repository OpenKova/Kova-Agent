"""Legacy alias for the renamed top-level ``kova_bootstrap`` module.

Installs that predate the hermes -> kova rename may still import
``hermes_bootstrap`` (from a still-loaded pre-update module or from
...
from kova_bootstrap import *  # noqa: F401,F403
