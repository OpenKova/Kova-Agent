"""Legacy alias for the renamed top-level ``kova_logging`` module.

Installs that predate the hermes -> kova rename may still import
``hermes_logging`` (from a still-loaded pre-update module or from
...
from kova_logging import *  # noqa: F401,F403
