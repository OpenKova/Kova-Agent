...
Storage path:
- `~/.hermes/plugins/kova-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.hermes/plugins/kova-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.hermes/plugins/kova-achievements/state.json` (existing unlock state)
  - `~/.hermes/plugins/kova-achievements/scan_snapshot.json` (new)
  - `~/.hermes/plugins/kova-achievements/scan_checkpoint.json` (new)
