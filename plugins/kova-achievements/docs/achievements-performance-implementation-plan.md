...
- Snapshot persisted at `~/.hermes/plugins/kova-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.hermes/plugins/kova-achievements/scan_checkpoint.json`.
