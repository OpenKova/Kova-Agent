...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def cancel_background_tasks(self) -> None:
        ...
        disconnect budget (``KOVA_GATEWAY_ADAPTER_DISCONNECT_TIMEOUT``, default
    ...
    async def _run_missed_message_backfill(self) -> None:
        ...
        that lack a substantive non-outage Kova response. Emoji-only acks are
    ...
    def _derive_auto_thread_name(self, content: str) -> str:
        ...
        Kova has an LLM-generated session title and can safely rename
