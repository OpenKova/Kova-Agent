...
# wiring imports this module for `kova --help`).
...
# when called later (gateway start, kova status). Cleared on success.
...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    # 3. Provision Spectrum credentials (runtime -> ~/.kova/.env,
