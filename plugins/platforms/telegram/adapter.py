...
# trigger its own recovery path. Refs: OpenKova/Kova-Agent#59614
...
# _UPDATER_STOP_TIMEOUT. Refs: OpenKova/Kova-Agent#66377
_DRAIN_TIMEOUT = 15.0
...
class TelegramAdapter(BasePlatformAdapter):
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: OpenKova/Kova-Agent#58270
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            _max_connect = 8
            _init_timeout = _env_float("KOVA_TELEGRAM_INIT_TIMEOUT", 30.0)
                ...
                try:
                    ...
                    if asyncio.get_running_loop().time() >= _total_deadline:
                        raise OSError(
                            ...
                            f"or set KOVA_TELEGRAM_HTTP_CONNECT_TIMEOUT / "
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `kova setup` to install Telegram support.",
