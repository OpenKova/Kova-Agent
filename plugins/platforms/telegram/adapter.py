...
# trigger its own recovery path. Refs: NousResearch/kova-agent#59614
...
# _UPDATER_STOP_TIMEOUT. Refs: NousResearch/kova-agent#66377
_DRAIN_TIMEOUT = 15.0
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: NousResearch/kova-agent#58270
