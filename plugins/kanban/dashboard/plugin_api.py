...
from kova_cli.kanban_db import (  # noqa: E402
...
def model_options():
    ...
    Thin wrapper around ``kova_cli.inventory.build_models_payload`` — the
    same substrate the dashboard Models page and the TUI picker use, so the
    dropdown can never offer a model/provider pair the rest of Kova
...
def list_kanban_projects():
    """List first-class Kova projects for board scoping.
