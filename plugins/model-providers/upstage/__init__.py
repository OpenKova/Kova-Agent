...
# When the user hasn't picked a reasoning effort, Kova passes
...
# ON at this effort — matching the "medium (default)" that Kova' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Kova' effort vocabulary onto Solar's accepted set. xhigh/max/
