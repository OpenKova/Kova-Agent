 ...
 * across theme x background scenes to <tmpdir>/kova-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@kova/ink'
...
// The regenerated slate light_colors block from kova_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/kova-agent',
...
const setup = (bgHex: string) => {
  process.env.KOVA_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
