...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [Discord de Neural Studio](https://discord.gg/NousResearch). Los usuarios pueden instalarla con `kova skills install`.
...
- Usa [GitHub Issues](https://github.com/OpenKova/Kova-Agent/issues)
