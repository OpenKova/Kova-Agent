...
def _read_allowlist_env(env_var: str) -> str:
    ...
    ``kova_cli.config.save_env_value`` / ``remove_env_value``, which target
...
class PairingStore:
    ...
    as ``kova -p <name> pairing ...``. This keeps multiplex gateways and
    ...
    def __init__(self, profile: Optional[str] = None):
        ...
        if profile:
            ...
            # ``kova -p <profile> pairing ...`` process does. Merge the
    ...
    def approve_request(self, platform: str, request_id: str) -> Optional[dict]:
        ...
        This is the grant path for authenticated admin surfaces (``kova
