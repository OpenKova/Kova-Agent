...
class PlatformRegistry:
    ...
    def __init__(self) -> None:
        ...
        # plugin-discovery time added several seconds to *every* `kova`
        # invocation -- including plain `kova chat`, which never touches any
        ...
        # `kova setup`/`gateway status`, send_message).
