...
# this script runs as a standalone subprocess — ``kova_constants`` isn't
...
def main() -> int:
    ...
    # Add repo root to sys.path so we can import kova_constants (this script
    ...
    if os.environ.get("KOVA_ENABLE_PROJECT_PLUGINS"):
        plugin_roots.append(Path.cwd() / ".kova" / "plugins")
