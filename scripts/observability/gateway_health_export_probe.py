...
def main() -> None:
    ...
    kova_home = Path(tempfile.mkdtemp(prefix="kova-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "kova-gateway-smoke",
    ...
    print(json.dumps({"kova_home": str(kova_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
