...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@kova.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "kavi@local.kova": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level KOVA_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (kova journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "kova.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.kova/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows kova-shim resolution + prefer --update on recovery; #52378)
    ...
    "zhchl@kova-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/OpenKova/Kova-Agent",
...
def main():
    ...
    print(f"{'='*60}")
    print("  Kova Agent Release Preview")
    print(f"{'='*60}")
