"""Session <-> workspace grouping key (kova_state.workspace_key).

The key is what `kova sessions list --workspace` groups/filters on. It is a
...
from kova_state import workspace_key
