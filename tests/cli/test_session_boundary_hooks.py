...
# tests/kova_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("kova_cli.lifecycle.invoke_hook")
@patch("kova_cli.lifecycle.finalize_session")
