...
class TestGetDueJobs:
    ...
    def test_one_shot_not_redispatched_while_running(self, tmp_cron_dir, monkeypatch):
        ...
        for gap in (28, 61, 130):
            monkeypatch.setattr("cron.jobs._kova_now",
    ...
    def test_one_shot_run_claim_expires_after_ttl(self, tmp_cron_dir, monkeypatch):
        ...
        monkeypatch.delenv("KOVA_CRON_TIMEOUT", raising=False)
        from cron.jobs import _kova_now, _oneshot_run_claim_ttl_seconds
    ...
    def test_run_claim_ttl_derived_from_cron_timeout(self, tmp_cron_dir, monkeypatch):
        """The stale-recovery TTL tracks KOVA_CRON_TIMEOUT (3x headroom), with
        ...
        monkeypatch.setenv("KOVA_CRON_TIMEOUT", "30")
        ...
        monkeypatch.setenv("KOVA_CRON_TIMEOUT", "not-a-number")
        assert ttl() == 1800.0
...
class TestLateEnvRepointScopesStore:
    """A KOVA_HOME set AFTER cron.jobs import must scope the store even
    ...
    def test_unchanged_home_returns_import_time_constants(self, monkeypatch):
        ...
        monkeypatch.setenv("KOVA_HOME", str(jobs.KOVA_DIR))
        store = jobs._current_cron_store()
    ...
    def test_use_cron_store_override_still_wins(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("KOVA_HOME", str(tmp_path / "env-home"))
    ...
    def test_patched_compatibility_constants_beat_env(self, tmp_path, monkeypatch):
        ...
        process-wide escape hatch — they win over a repointed KOVA_HOME."""
        import cron.jobs as jobs
    ...
    def test_public_io_after_late_env_repoint_leaves_old_file_untouched(
        ...
        called after a post-import KOVA_HOME repoint must operate on the NEW
        ...
        monkeypatch.setattr(jobs, "KOVA_DIR", sim_old_home)
        ...
        monkeypatch.setenv("KOVA_HOME", str(new_home))
