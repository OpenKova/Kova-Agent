...
Run from the PR worktree:
    ...
    cd ~/.hermes/kova-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.hermes/kova-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.hermes/kova-agent
