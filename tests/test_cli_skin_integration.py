...
class TestCompactBannerSkinIntegration:
    def test_default_compact_banner_keeps_legacy_kova_branding(self):
        set_active_skin("default")
        ...
        assert "KOVA" in banner

    def test_poseidon_compact_banner_uses_skin_branding_instead_of_kova(self):
