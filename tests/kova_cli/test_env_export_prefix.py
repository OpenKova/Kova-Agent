...
hand-rolled parsers — ``kova_cli.config.load_env``,
``kova_cli.main._has_any_provider_configured``, and
...
def test_skills_tool_load_env_strips_export_prefix(tmp_path, monkeypatch):
    ...
    # skills_tool.load_env reads get_kova_home()/.env directly.
    import importlib

    import tools.skills_tool as skills_tool

    importlib.reload(skills_tool)
    with patch.object(skills_tool, "get_kova_home", return_value=tmp_path):
