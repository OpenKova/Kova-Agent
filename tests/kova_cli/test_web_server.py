...
class TestWebServerEndpoints:
    ...
    def test_profiles_sidebar_heals_stale_schema_store(self):
        ...
        array — the desktop rendered "No sessions yet" after `kova update`
    ...
    def test_heal_gives_up_when_reconcile_cannot_fix_the_store(self, monkeypatch):
        ...
        original_init = kova_state.SessionDB.__init__
        ...
        # the class on kova_state covers every open the helper makes.
        monkeypatch.setattr(kova_state.SessionDB, "__init__", counting_init)
    ...
    def test_update_kova_spawns_with_action_id(self, monkeypatch):
        import kova_cli.web_server as web_server
        ...
        assert calls == [
            (["update"], "kova-update", {"KOVA_ACTION_ID": "a" * 32})
        ]

    def test_update_kova_reuses_running_action(self, monkeypatch):
        import kova_cli.web_server as web_server
        ...
        web_server._ACTION_IDS["kova-update"] = "b" * 32

        try:
            resp = self.client.post("/api/kova/update")
        finally:
            web_server._ACTION_PROCS.pop("kova-update", None)
            web_server._ACTION_IDS.pop("kova-update", None)
    ...
    def test_platform_scoped_messaging_env_vars_are_channel_managed(self):
        ...
        tests/kova_cli/test_setup_hidden_env.py.
        """
        ...
        def fake_request(method, path, *, body=None, bearer_token=None):
            if method == "POST":
                return {
                    ...
                    "deep_link": "https://t.me/newbot/HermesSetupBot/kova_pair_restart_fails_bot",
                    "qr_payload": "https://t.me/newbot/HermesSetupBot/kova_pair_restart_fails_bot",
    ...
    def test_deleting_the_active_custom_endpoint_clears_its_model_mirror(self):
        ...
        """
        from kova_cli.config import custom_endpoint_key_env, get_env_value, load_config
    ...
    def test_custom_endpoint_save_leaves_a_hand_written_env_ref_alone(self, monkeypatch):
        ...
        from kova_cli.config import custom_endpoint_key_env, get_config_path, get_env_value
    ...
    def test_two_endpoints_on_one_host_keep_separate_credentials(self):
        ...
        the first's key.
        """
        from kova_cli.config import custom_endpoint_key_env, get_env_value
...
class TestBuildSchemaFromConfig:
    ...
    def test_timezone_field_is_searchable_select(self):
        ...
        """
        from kova_cli.web_server import CONFIG_SCHEMA, _timezone_options
...
class TestNewEndpoints:
    ...
    def test_toolsets_resolve_subscription_features_once(self, monkeypatch):
        ...
        from kova_cli.nous_subscription import NousSubscriptionFeatures
...
class TestHashedAssetCacheHeaders:
    ...
    def test_serve_css_is_immutable_and_keeps_prefix_rewrites(
        ...
        assert "url(/kova/ds-assets/bg.png)" in prefixed.text
        assert "url(/kova/fonts-terminal/x.woff2)" in prefixed.text
