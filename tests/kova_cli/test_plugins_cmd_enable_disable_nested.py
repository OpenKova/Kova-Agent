...
class TestEnableDisableNested:
    ...
    def test_enable_clears_manifest_name_alias_from_disabled(
        ...
        ``kova plugins disable web-firecrawl`` gets ``web-firecrawl`` in
        ...
        with patch(
            "kova_cli.plugins_cmd._get_disabled_set",
...
class TestEnableToolOverrideConsent:
    ...
    @patch("kova_cli.plugins.get_bundled_plugins_dir")
    @patch("kova_cli.plugins_cmd._plugins_dir")
    @patch("kova_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("kova_cli.plugins_cmd._save_disabled_set")
    @patch("kova_cli.plugins_cmd._save_enabled_set")
    @patch("kova_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("kova_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `kova plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from kova_cli.plugins_cmd import _run_composite_fallback
