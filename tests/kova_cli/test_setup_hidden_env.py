...
from kova_cli.setup_hidden_env import is_setup_hidden_env
...
class TestChannelCards:
    ...
    def test_no_card_shows_a_hidden_knob(self):
        from kova_cli.web_server import _messaging_platform_catalog
...
class TestCliWizard:
    """`kova setup gateway` drops the same knobs. Real wizard, scripted
