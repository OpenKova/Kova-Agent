...
class TestAcceptHooksOnAgentSubparsers:
    ...
    # One driver subprocess parses ALL argvs: kova_cli.main is a very heavy
    # import (previously 11 separate `python -m kova_cli.main` spawns with a
...
class TestChatSubparserInheritedValueFlags:
    ...
    Uses the real `kova_cli._parser.build_top_level_parser()` rather than
