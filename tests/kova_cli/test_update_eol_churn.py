"""Regression: ``kova update`` should take a managed checkout off autocrlf=true.
...
``kova update`` has to repair them.
...
from kova_cli.update_cmd import _normalize_managed_eol
