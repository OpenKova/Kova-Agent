"""Tests for `kova secrets bitwarden token` / `kova secrets onepassword token`.
...
from kova_cli import onepassword_secrets_cli as op_cli
from kova_cli import secrets_cli as bw_cli
