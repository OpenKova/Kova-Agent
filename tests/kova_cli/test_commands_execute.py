...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`kova_cli.slash_exec.EXECUTORS`, and
...
from kova_cli.commands import COMMAND_REGISTRY, resolve_command
from kova_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
