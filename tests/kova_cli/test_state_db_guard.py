...
from kova_cli.backup import copy_db_and_verify, verify_sqlite_integrity
...
class TestPreUpdateBackupIntegrityGuard:
    ...
    def test_healthy_db_stays_quiet(self, kova_home, capsys):
    ...
    def test_zeroed_db_after_snapshot_is_loud(self, kova_home, capsys, monkeypatch):
