...
def test_topup_overview_splits_onetime_from_automatic_copy(cli, monkeypatch, capsys):
    ...
    monkeypatch.setattr(KovaCLI, "_prompt_text_input_modal", _scripted("cancel"), raising=False)
...
def test_buy_flow_no_card_guides_then_continues_after_recheck(cli, monkeypatch, capsys):
    ...
    monkeypatch.setattr(KovaCLI, "_prompt_text_input_modal", _scripted("recheck", "cancel"), raising=False)
