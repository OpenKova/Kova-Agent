...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (kova_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_kova_overlays():
    """kova_cli.providers.get_provider("vertex") backs
