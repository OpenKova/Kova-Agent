"""Tests for ``kova approvals suggest`` (kova_cli/approvals_suggest.py).

Approval history in Kova is implied, not ledgered: the session DB
...
from kova_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
