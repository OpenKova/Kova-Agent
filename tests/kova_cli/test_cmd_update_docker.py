...
def test_cmd_update_in_docker_prints_guidance_and_exits(
    ...
    assert "docker pull OpenKova/Kova-Agent:latest" in out
...
@patch("kova_cli.config.is_managed", return_value=False)
@patch("kova_cli.config.detect_install_method", return_value="nix")
@patch("kova_cli.main._cmd_update_impl")
...
def test_format_docker_update_message_contents():
    ...
    assert "docker pull OpenKova/Kova-Agent:latest" in msg
