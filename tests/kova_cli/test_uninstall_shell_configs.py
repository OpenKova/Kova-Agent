...
This rewrites files Kova does not own (``~/.bashrc``, ``~/.zshrc``, ...) and
...
class TestHappyPath:
    def test_kova_path_block_is_removed(self, fake_home: Path):
        rc = fake_home / ".zshrc"
...
class TestCrashDurability:
    ...
    def test_symlinked_shell_config_stays_a_symlink(self, fake_home: Path):
        ...
        assert "# Kova Agent" not in real.read_text(encoding="utf-8")
