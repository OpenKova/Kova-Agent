...
(hermes, kova-agent, hermes-acp, gateway, batch_runner, cli.py).  It
...
Key invariants covered by these tests:
  ...
  5. Load order: every Kova entry point imports hermes_bootstrap as its
...
class TestEntryPointsImportBootstrap:
    """Every Kova entry point must import hermes_bootstrap as its
