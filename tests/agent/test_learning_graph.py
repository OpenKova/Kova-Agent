...
def test_kova_meta_tolerates_non_dict():
    assert learning_graph._kova_meta({"metadata": "junk"}) == {}
    assert learning_graph._kova_meta({"metadata": {"kova": "junk"}}) == {}
    assert learning_graph._kova_meta({"metadata": {"kova": {"category": "x"}}}) == {"category": "x"}
