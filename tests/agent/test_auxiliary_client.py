...
class TestResolveTaskProviderModel:
    ...
    def test_config_provider_moa_falls_back_to_default_preset(self, monkeypatch):
        ...
        preset = {
            "aggregator": {"provider": "nous", "model": "kova-4-405b"},
        }
        ...
        monkeypatch.setattr("kova_cli.moa_config.resolve_moa_preset", fake_resolve)
        monkeypatch.setattr("kova_cli.config.load_config", lambda: {"moa": {}})
...
class TestMoaAggregatorSharedResolution:
    ...
    Real-config tests: write an actual config.yaml under a temp KOVA_HOME
...
class TestBuildCallKwargsMaxTokens:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("nous", "kova-4", "https://inference-api.kova.ai/v1"),
...
class TestAuxiliaryPoolAwareness:
    ...
    def test_try_nous_uses_portal_recommendation_for_text(self):
        ...
        fresh_base = "https://inference-api.kova.ai/v1"
        with (
    ...
    async def test_async_call_llm_retries_nous_after_401(self):
        ...
        fresh_async_client.base_url = "https://inference-api.kova.ai/v1"
...
class TestAuxiliaryAuthRefreshRetry:
    ...
    def test_resolve_provider_client_vertex_builds_client_from_minted_token(self):
        ...
        the PROVIDER_REGISTRY lookup (a plain KOVA_OVERLAYS-only fix would
