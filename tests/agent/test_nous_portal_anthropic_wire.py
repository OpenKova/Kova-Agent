...
``https://inference-api.kova.ai/v1/messages`` alongside the
...
PORTAL_URL = "https://inference-api.kova.ai/v1"
...
class TestApiModeRouting:
    ...
    def test_determine_api_mode_honors_the_model_for_nous(self):
        ...
        assert (
            determine_api_mode("nous", PORTAL_URL, model="kova-4-405b")
            == "chat_completions"
        )
...
class TestRuntimeResolution:
    ...
    def test_target_model_wins_over_the_persisted_default(self, monkeypatch):
        ...
        monkeypatch.setattr(
            rp,
            "_get_model_config",
            lambda: {"provider": "nous", "default": "kova-4-405b"},
        )
...
class TestClientShape:
    ...
    def test_lookalike_host_does_not_get_portal_treatment(self):
        ...
        spoofed = "https://inference-api.kova.ai.attacker.test/v1"
    ...
    def test_non_anthropic_catalog_model_stays_on_chat_completions(self):
        ...
        with (
            patch(
                ...
                return_value=(plain, "kova-4-405b"),
            ),
            patch(
            ...
            client, model = resolve_provider_client("nous", "kova-4-405b")
