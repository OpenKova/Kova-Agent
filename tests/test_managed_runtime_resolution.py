...
Kova installs runtimes for itself — ``uv`` at ``$HERMES_HOME/bin/uv``, Node at
...
# Runtimes Kova provisions into HERMES_HOME and must therefore resolve
...
def test_managed_uv_helpers_exist():
    from kova_cli.managed_uv import ensure_uv, managed_uv_path, resolve_uv
