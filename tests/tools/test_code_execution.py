...
class TestRpcTokenAuthorization(unittest.TestCase):
    ...
    request without the matching KOVA_RPC_TOKEN must be rejected before
    ...
    def test_generated_module_sends_token(self):
        """The generated kova_tools module reads KOVA_RPC_TOKEN and sends it."""
        src = generate_kova_tools_module(["terminal"], transport="uds")
        self.assertIn("KOVA_RPC_TOKEN", src)
