...
class TestClickButtonPassthrough:
    """Surface 5 (OpenKova/Kova-Agent#47072) — `middle_click` must
...
class TestImageMimeTypePropagation:
    """Surface 7 (OpenKova/Kova-Agent#47072): trycua/cua#1961 made
...
class TestStructuredElementsConsumption:
    """Surface 2 (OpenKova/Kova-Agent#47072): trycua/cua#1961 made
...
class TestCapabilityDiscovery:
    """Surface 4 (OpenKova/Kova-Agent#47072): the wrapper learns
...
class TestElementTokenAttachment:
    """Surface 6 (OpenKova/Kova-Agent#47072): trycua/cua#1961 added
