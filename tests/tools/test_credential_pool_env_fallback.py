...
class TestCredentialPoolSeedsFromDotEnv:
    ...
    def test_dotenv_wins_over_stale_os_environ(self, isolated_kova_home, monkeypatch):
        ...
        """
        _write_env_file(isolated_kova_home, DEEPSEEK_API_KEY="sk-dotenv-fresh")
...
class TestAuthResolvesFromDotEnv:
    ...
    def test_dotenv_wins_over_stale_os_environ_on_resolve(
        ...
        """
        _write_env_file(isolated_kova_home, DEEPSEEK_API_KEY="dotenv-fresh-deepseek")
    ...
    def test_get_anthropic_key_prefers_dotenv_over_stale_os_environ(
        ...
        """
        _write_env_file(isolated_kova_home, ANTHROPIC_API_KEY="dotenv-fresh-anthropic")
...
class TestAnthropicEnvAuthTypeClassification:
    ...
    def test_admin_key_classified_as_api_key(self, isolated_kova_home):
        ...
        _write_env_file(isolated_kova_home, ANTHROPIC_API_KEY="sk-ant-admin-fake-12345")
        entry = self._seed("ANTHROPIC_API_KEY", "sk-ant-admin-fake-12345")
        assert entry.auth_type == AUTH_TYPE_API_KEY

    def test_standard_api_key_classified_as_api_key(self, isolated_kova_home):
        """sk-ant-api- key → AUTH_TYPE_API_KEY (unchanged behaviour)."""
        from agent.credential_pool import AUTH_TYPE_API_KEY
        _write_env_file(isolated_kova_home, ANTHROPIC_API_KEY="sk-ant-api-fake-12345")
