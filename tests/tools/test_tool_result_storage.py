...
class TestMaybePersistToolResult:
    ...
    def test_tool_use_id_cannot_escape_storage_dir(self):
        ...
        assert "Full output saved to: /tmp/kova-results/outside_whoami_x_" in result
        assert "/tmp/kova-results/../" not in result
        assert target.startswith("/tmp/kova-results/outside_whoami_x_")
