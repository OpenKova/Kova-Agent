...
class TestGoogleMeetSpawn:
    def test_child_env_carries_scoped_openai_key(
        ...
        monkeypatch.delenv("KOVA_MEET_REALTIME_KEY", raising=False)
        ...
        assert child_env["KOVA_MEET_REALTIME_KEY"] == "scoped-openai-key"
    ...
    def test_explicit_key_argument_still_wins(
        ...
        assert captured["env"]["KOVA_MEET_REALTIME_KEY"] == "explicit-key"
