...
def test_non_git_cwd_can_group_inside_a_junk_repo_subtree():
    ...
    workspace = _session("/home/test/.kova/workspaces/notes")
    ...
    tree = pt.build_tree(
        ...
        hydrate=True,
        is_junk_root=lambda path: path.startswith("/home/test/.kova"),
        is_junk_cwd=lambda path: path in {"/home/test", "/home/test/.kova"},
    )

    assert [p["id"] for p in tree["projects"]] == ["/home/test/.kova/workspaces/notes"]
