...
def test_session_store_default_db_uses_runtime_kova_home(tmp_path, monkeypatch):
    ...
    kova_state before a fixture redirected HERMES_HOME used to pin every
    default SessionDB() at the developer's real ~/.kova/state.db.
    """
    config = GatewayConfig(default_reset_policy=SessionResetPolicy(mode="none"))
    fake_home = tmp_path / "alt_kova_home"
    fake_home.mkdir()
