...
class TestGetProcessKovaHome:
    """Tests for get_process_kova_home() — process launch scope.
    ...
    def test_ignores_context_local_override(self, tmp_path, monkeypatch):
        ...
        try:
            ...
            assert get_process_kova_home() == launch_home
        finally:
...
class TestResolvePerModelReasoningEffort:
    ...
    def test_exact_match(self):
        ...
        from kova_constants import resolve_per_model_reasoning_effort
...
class TestReasoningOverridesDefaultConfig:
    ...
    def test_load_config_preserves_user_reasoning_overrides(self, tmp_path, monkeypatch):
        ...
        import yaml
        from kova_cli.config import load_config, get_config_path
...
class TestWslPathTranslation:
    ...
    def test_windows_drive_to_wsl_mount(self):
        assert kova_constants.windows_path_to_wsl(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert kova_constants.windows_path_to_wsl("C:/Users/alex") == "/mnt/c/Users/alex"
        assert kova_constants.windows_path_to_wsl("D:\\") == "/mnt/d/"

    def test_windows_drive_ignores_non_drive_paths(self):
        assert kova_constants.windows_path_to_wsl("/home/alex") is None
        assert kova_constants.windows_path_to_wsl("relative\\dir") is None

    def test_wsl_unc_to_posix_both_spellings(self):
        assert kova_constants.wsl_unc_path_to_posix(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        assert kova_constants.wsl_unc_path_to_posix(r"\\wsl$\Ubuntu\home\alex") == "/home/alex"
        # Forward-slash spelling and distro root.
        assert kova_constants.wsl_unc_path_to_posix("//wsl.localhost/Debian/srv/app") == "/srv/app"
        assert kova_constants.wsl_unc_path_to_posix("\\\\wsl.localhost\\Ubuntu\\") == "/"

    def test_wsl_unc_ignores_non_unc_paths(self):
        assert kova_constants.wsl_unc_path_to_posix(r"C:\Users\alex") is None
        assert kova_constants.wsl_unc_path_to_posix("/home/alex") is None

    def test_translate_is_noop_off_wsl(self, monkeypatch):
        monkeypatch.setattr(kova_constants, "is_wsl", lambda: False)
        assert kova_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == r"C:\Users\alex"

    def test_translate_maps_windows_and_unc_on_wsl(self, monkeypatch):
        monkeypatch.setattr(kova_constants, "is_wsl", lambda: True)
        assert kova_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert kova_constants.translate_cwd_for_wsl_backend(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        # Already-POSIX paths pass through untouched.
        assert kova_constants.translate_cwd_for_wsl_backend("/home/alex") == "/home/alex"
