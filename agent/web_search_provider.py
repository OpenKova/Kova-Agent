...
def get_provider_env(name: str) -> str:
    ...
    Resolves *name* via :func:`kova_cli.config.get_env_value` (checks
    ``os.environ`` first, then ``~/.kova/.env``) so credentials set
    through Kova' config layer are visible even when they were never
