...
def load_env_file(env_path: Path) -> Dict[str, str]:
    ...
    ``set_secret_scope``. Parses the small KEY=VALUE subset Kova writes
    ...
    ``kova_cli.config._parse_env_value``) but never mutates the process
    ...
    # Parse values with the canonical Kova parser: save_env_value
    ...
    from kova_cli.config import _parse_env_value
