...
class CodexAppServerSession:
    ...
    def _decide_exec_approval(self, params: dict) -> str:
        ...
        This is protocol-level routing only — it carries NO Kova
        approval-mode/timeout logic. The Kova-side resolution happens
    ...
    def _decide_apply_patch_approval(self, params: dict) -> str:
        ...
        Protocol-level routing only; Kova approval-mode/timeout
...
def _approval_choice_to_codex_decision(choice: str) -> str:
    ...
    NOT in tools/approval.py: the Kova approval mode/timeout resolution
    ...
    # "prompt expired"; the Kova-side messaging already distinguishes them.
    return "decline"
