"""Core NeMo Relay adapter for Kova tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Kova tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Kova Relay tool execution cannot run on an active event-loop thread"
    )
