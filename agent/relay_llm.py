"""Core NeMo Relay adapters for physical Kova provider attempts."""
...
def execute_current(
    ...
    *,
    ...
    """Run a provider attempt under the inherited Kova turn when present."""
...
def stream_current(
    ...
    *,
    ...
    """Run a provider stream under the inherited Kova turn when present.
...
class ManagedLlmStream(Iterator[Any]):
    """Drive Relay's async stream from Kova's provider worker thread."""
...
class AnthropicStreamAccumulator:
    ...
    def response(self, base: Any = None) -> Any:
        """Return the attribute-shaped response consumed by Kova."""
