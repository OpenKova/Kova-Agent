...
def compress_context(
    ...
    *,
    ...
    # ``compression.codex_app_server_auto`` (native|kova|off; legacy "kova"
    # value is accepted and treated as "kova").
...
def _compress_context_via_codex_app_server(
    ...
    *,
    ...
    # Legacy "kova" value from pre-rename configs is accepted and treated
    # identically to "kova".
    if auto_mode == "kova":
        auto_mode = "kova"
