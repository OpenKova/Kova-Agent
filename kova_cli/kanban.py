...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    p_attach.add_argument("--author", default=None,
                          help="uploaded_by label (default: $KOVA_PROFILE or 'user')")
...
def kanban_command(args: argparse.Namespace) -> int:
    ...
    # kova_cli.kanban_db, because children can import DB mutators directly.
    ...
    with board_scope:
        ...
        # every `kova kanban repair` into "could not initialize database"
...
def _is_delegated_child_cli_mutation(args: argparse.Namespace) -> bool:
    ...
    try:
        ...
        return bool(os.environ.get("KOVA_DELEGATED_CHILD_CONTEXT"))
...
def _cmd_complete(args: argparse.Namespace) -> int:
    ...
    with kb.connect_closing() as conn:
        for tid in ids:
            ...
            # `kova kanban complete <id>` from the terminal tool and
            ...
            if task and task.goal_mode:
                ...
                if judge_available:
                    ...
                    try:
                        ...
                        # kova_cli/goals.py. Unpacking fewer raises
