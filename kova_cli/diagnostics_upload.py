"""Client for uploading ``kova debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``kova debug share``.
...
NAS_BASE = os.environ.get(
    "KOVA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
