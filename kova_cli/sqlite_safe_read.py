...
Kova is exactly the topology this hits: gateway, dispatcher, dashboard,
...
class _TrackingMixin:
    ...
    _kova_tracked_path: str | None = None

    def close(self) -> None:  # type: ignore[misc]
        with _live_lock:
            path = getattr(self, "_kova_tracked_path", None)
    ...
    **kwargs,
    ...
    with _live_lock:
        ...
        try:
            ...
            conn._kova_tracked_path = resolved
