...
def _build_full_manifest(
    ...
    By default, this keeps Kova on Slack's older Assistant messaging
...
def slack_manifest_command(args) -> int:
    ...
    if getattr(args, "slashes_only", False) and (
        ...
        print(
            "kova slack manifest: long description options cannot be used "
            "with --slashes-only",
            file=sys.stderr,
        )
        return 2
    ...
    if (
        ...
        print(
            "kova slack manifest: long description must be at least "
    ...
    if (
        ...
        print(
            "kova slack manifest: long description must be at most "
