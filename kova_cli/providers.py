...
def resolve_provider_full(
    ...
    # 0.5 Exact Kova provider IDs must win over LOSSY alias collapsing.
    ...
    if canonical != raw:
        try:
            from kova_cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
