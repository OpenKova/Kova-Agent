...
def _has_agent_browser() -> bool:
    ...
    from kova_constants import agent_browser_runnable, with_kova_node_path
    ...
    # Kova-managed Node dirs (Windows installer / POSIX $HERMES_HOME/node)
    ...
    managed_path = with_kova_node_path().get("PATH", "")
    if managed_path:
