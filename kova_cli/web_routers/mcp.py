...
web_server - reached via the late-binding seam in :mod:`kova_cli.web_deps`
...
from kova_cli.web_deps import late, LateState
from kova_cli.web_models import (
    MCPCatalogInstall,
    MCPEnabledToggle,
    MCPServerCreate,
    MCPServersReplace,
...
_log = logging.getLogger("kova_cli.web_server")
...
_spawn_kova_action = late("_spawn_kova_action")
