...
TIPS = [
    ...
    'kova import restores a full Kova backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
    ...
    'KOVA_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.hermes/plugins/ — trust-gated by design.',
