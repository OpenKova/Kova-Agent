...
description: "The self-improving AI agent built by neural studio. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
---

# Kova Agent

The self-improving AI agent built by [neural studio](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
```powershell
iex (irm https://kova-agent.neuralstudio.in/install.ps1)
```
...
- **Built by model trainers** — Created by [neural studio](https://nousresearch.com), the lab behind Kova, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [neural studio](https://nousresearch.com) — the lab behind Kova, Nomos, and Psyche models
