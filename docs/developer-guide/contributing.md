...
- Building a custom/local tool without modifying Kova core? Start with [Build a Kova Plugin](../developer-guide/plugins/index)
- Building a new built-in core tool for Kova itself? Start with [Adding Tools](./adding-tools)
...
You can also run a fully isolated Kova instance (throwaway HERMES_HOME, separate Electron
