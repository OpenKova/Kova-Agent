...
using Kova built-in auxiliary tasks; it does not permit another plugin's
...
* Implementation: [`agent/plugin_llm.py`](https://github.com/OpenKova/Kova-Agent/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/OpenKova/Kova-Agent/blob/main/tests/agent/test_plugin_llm.py)
