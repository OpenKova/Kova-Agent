...
| Version | `2.0.0` |
| Author | Francesco Bonacci (f-trycua), Kova Agent |
| License | MIT |
...
Normal Kova sessions use `standard`, which requires a certified protected
host and fails closed when Kova has none. Explicit Kova YOLO (`--yolo`,
