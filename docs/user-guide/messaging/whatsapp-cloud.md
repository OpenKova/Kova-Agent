...
If those constraints don't work for your use case, the [Baileys bridge integration](./whatsapp) is the alternative — personal account, no public URL needed, but unofficial and ban-prone.

:::tip Which one should I use?
- **Cloud API (this guide)** — running a real business bot, want stability, fine with the Meta verification + template paperwork
- **[Baileys bridge](./whatsapp)** — personal projects, quick demos, single-user setups, willing to risk the bot phone number's account
:::
...
- [WhatsApp (Baileys bridge) Setup](whatsapp) — the alternative integration for personal projects.
- [Messaging Platforms overview](index) — all messaging integrations at a glance.
