...
| OpenAI Codex | `openai-codex` | `kova model` → **ChatGPT or Codex Subscription** (ChatGPT OAuth) |
...
| `"codex"` | Force Codex OAuth | `kova model` → ChatGPT or Codex Subscription |
