...
![Kanban board overview](/assets/kanban-tutorial/01-board-overview.png)
...
![Board with lanes by profile off](/assets/kanban-tutorial/02-board-flat.png)
...
![Solo dev — completed schema task drawer](/assets/kanban-tutorial/03-drawer-schema-task.png)
...
![Fleet view filtered to transcribe tasks](/assets/kanban-tutorial/07-fleet-transcribes.png)
...
![Pipeline view for a multi-role feature](/assets/kanban-tutorial/08-pipeline-auth.png)
...
![Reviewer's drawer view of the pipeline](/assets/kanban-tutorial/09-drawer-pipeline-review.png)
...
![Circuit breaker — 2 spawn_failed + 1 gave_up](/assets/kanban-tutorial/11-drawer-gave-up.png)
...
![Crash and recovery — 1 crashed + 1 completed](/assets/kanban-tutorial/06-drawer-crash-recovery.png)
...
```bash
kova kanban create "Fix CI: test_backoff_jitter flakes on 3.11" \
...
![Claimed, in-flight task](/assets/kanban-tutorial/10-drawer-in-flight.png)
