...
every [profile](../profiles) on the machine. A profile switcher in the
...
![Config admin page — section filters on the left, auto-discovered fields on the right](/assets/dashboard/admin-config.png)
...
![Sessions admin page — stats bar, prune, and per-row rename / export / delete](/assets/dashboard/admin-sessions.png)
...
Create and manage [profiles](../profiles) — isolated Kova instances with their own config, skills, and sessions.
...
![Skills admin page — the Browse hub view: search, install, and update](/assets/dashboard/admin-skills-hub.png)
...
![MCP admin page — your servers with enable/disable toggles, plus the install catalog](/assets/dashboard/admin-mcp.png)
...
![Webhooks admin page — subscriptions with enable/disable toggles](/assets/dashboard/admin-webhooks.png)
...
![Pairing admin page](/assets/dashboard/admin-pairing.png)
...
![Channels admin page — every messaging platform with status, enable toggles, and per-platform setup forms](/assets/dashboard/admin-channels.png)
...
![System admin page — host stats and Nous Portal status](/assets/dashboard/admin-system-top.png)

![System admin page — skill curator, gateway, memory, and credential pool](/assets/dashboard/admin-system-curator.png)

![System admin page — operations, checkpoints, and shell hooks](/assets/dashboard/admin-system-ops.png)

Creating a shell hook (note the consent checkbox and the run-arbitrary-commands warning):

![New shell hook modal](/assets/dashboard/admin-hook-create.png)
