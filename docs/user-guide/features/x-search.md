...
Kova can expose two different X surfaces:
...
|------------|--------|-------|
| **SuperGrok / X Premium+ OAuth** (preferred) | Browser login at `accounts.x.ai`, refreshed automatically | `kova auth add xai-oauth` — see [xAI Grok OAuth (SuperGrok / X Premium+)](../../guides/xai-grok-oauth) |
...
- [xAI Grok OAuth (SuperGrok / Premium+)](../../guides/xai-grok-oauth) — the OAuth setup guide
- [xurl skill](../skills/bundled/social-media/social-media-xurl) — official X API CLI for authenticated account actions
- [Web Search & Extract](web-search) — for general (non-X) web search
- [Tools Reference](../../reference/tools-reference) — full tool catalog
