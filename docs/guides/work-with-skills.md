...
For how to ship skills in your own plugin, see [Build a Kova Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
kova config get skills.config --json
```
