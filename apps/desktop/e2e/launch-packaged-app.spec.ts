...
/**
 * E2E smoke tests for the packaged Kova desktop app.
 *
 ...
 * (credential stripping, isolated KOVA_HOME + userData, unique app name).
 *
...
test('window opens with the Kova title', async () => {
