...
export const ZOOM_STORAGE_KEY = 'kova:desktop:zoomLevel'
 ...
 * but forgot to emit 'kova:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('kova:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
