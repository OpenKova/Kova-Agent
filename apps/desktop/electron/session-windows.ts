...
// by main.ts (`setBackgroundThrottling` driven by the merged `kova:active-work`
...
// (the "Kova idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Kova" wake word has NO preceding click,
