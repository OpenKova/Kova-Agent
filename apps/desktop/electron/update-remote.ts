 ...
 *
 * A public install can end up with `origin=git@github.com:nousresearch/kova-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/nousresearch/kova-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/kova-agent'
