 ...
 *
 * A public install can end up with `origin=git@github.com:OpenKova/Kova-Agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/OpenKova/Kova-Agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/openkova/kova-agent'
