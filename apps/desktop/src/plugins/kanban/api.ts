...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@kova/plugin-sdk'
...
/** First-class Kova projects, for scoping a board's default workspace. */
