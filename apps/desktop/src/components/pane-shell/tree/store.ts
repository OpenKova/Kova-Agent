...
const STORAGE_KEY = 'kova.desktop.layoutTree.v2'
 ...
 */
export const $activePresetId = atom<string>(readKey('kova.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('kova.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'kova.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'kova.desktop.userPlacedPanes.v1'
