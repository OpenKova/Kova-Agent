...
export const en: Translations = {
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Kova was in the background.'
        }
      },
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Kova can react to yours.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Kova.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Kova backend elsewhere. Per-profile overrides below.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Kova backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Kova Cloud',
      cloudDesc: 'Sign in once to Kova Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Kova Cloud',
      cloudSignIn: 'Sign in to Kova Cloud',
      cloudSignedIn: 'Signed in to Kova Cloud',
      cloudNeedsSignIn: 'Sign in to Kova Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Kova Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Kova Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Kova Cloud',
      cloudSignedOutMessage: 'Cleared the Kova Cloud session.',
      ...
      restartingMessage: 'Kova Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        'Kova is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Kova path (optional)',
      sshHermesPathDesc: 'Full path to the remote kova binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Kova found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Kova runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Kova is not installed on the remote host. Install it there (curl -fsSL https://kova-agent.nousresearch.com/install.sh | sh) or set the Kova path.',
      sshErrPlatform:
        'Unsupported remote platform. Kova Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Kova on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Kova at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  install: {
    ...
    installLocalTitle: 'Install Kova locally',
    installLocalDesc: 'Download Kova, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Kova Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Kova',
    remoteSetupDesc: 'Enter your gateway URL. Kova Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Kova gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/kova',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Kova gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
