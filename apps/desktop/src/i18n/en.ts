...
export const en: Translations = {
  ...
  settings: {
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Kova writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    gateway: {
      ...
      sshKovaPathTitle: 'Kova path (optional)',
      sshKovaPathDesc: 'Full path to the remote kova binary. Blank = auto-detect.',
      sshKovaPathPlaceholder: 'auto-detect',
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Kova subscription — sign in to Kova Portal to activate.',
      nousAuthNeededTitle: 'Sign in to Kova Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Kova Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Kova Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Kova Portal sign-in did not complete',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Kova subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Connected to Kova Cloud at ${host} · click to manage`,
