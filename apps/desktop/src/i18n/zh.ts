...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        '远程主机上未安装 Kova。请在远程安装（curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh）或设置 Kova 路径。',
    ...
    toolsets: {
      ...
      needsSignIn: '需要登录',
      needsSetup: '需要安装',
      nousIncluded: '包含在 Kova 订阅中；登录 Kova Portal 即可激活。',
      nousAuthNeededTitle: '登录 Kova Portal',
      nousAuthNeededMessage: provider => `已保存 ${provider}，但在登录 Kova Portal 之前不会激活。`,
      nousAuthSignIn: '登录',
      nousAuthDoneTitle: '已连接 Kova Portal',
      nousAuthDoneMessage: '订阅后端现已激活。',
      nousAuthFailed: 'Kova Portal 登录未完成',
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      weixin:
        '运行 `hermes gateway setup`，选择 Weixin，然后使用个人微信账号扫描并确认二维码。Kova 会通过腾讯 iLink Bot API 连接并保存凭据。',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付费 Kova 订阅。',
    free: '免费',
    freeTier: '免费层',
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `已连接到 Kova Cloud ${host} · 点击管理`,
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.hermes/config.yaml)。Kova 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
