...
export const ja = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Kova Desktop を起動中…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Kova がインストールされていません。リモートでインストールする（curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh）か、Kova パスを設定してください。',
      sshErrPlatform:
    ...
    toolsets: {
      ...
      nousIncluded: 'Kova サブスクリプションに含まれています。有効にするには Kova Portal にサインインしてください。',
      nousAuthNeededTitle: 'Kova Portal にサインイン',
      nousAuthNeededMessage: provider =>
        `${provider} は保存されましたが、Kova Portal にサインインするまで有効になりません。`,
      nousAuthSignIn: 'サインイン',
      nousAuthDoneTitle: 'Kova Portal に接続しました',
      nousAuthDoneMessage: 'サブスクリプションのバックエンドが有効になりました。',
      nousAuthFailed: 'Kova Portal のサインインが完了しませんでした',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro モデルには有料の Kova サブスクリプションが必要です。',
    free: '無料',
    freeTier: '無料プラン',
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Kova Cloud ${host} に接続中 · クリックして管理`,
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `これにより "${pattern}" パターンが永続的な許可リスト (~/.hermes/config.yaml) に追加されます。Kova はこのセッションや将来のセッションで、このようなコマンドについて再度尋ねません。`,
      alwaysAllow: '常に許可'
    },
    clarify: {
