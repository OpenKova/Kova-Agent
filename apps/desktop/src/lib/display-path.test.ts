...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/kova-agent')).toBe('~/www/kova-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/kova-agent')).toBe('kova-agent')
    expect(pathLeaf('~/www/kova-agent')).toBe('kova-agent')
