...
import { type BillingBlock, skillInvocationText } from '@kova/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/kova'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @kova/shared BillingBlock).
