...
const INSTALL_METHOD_TOAST_SNOOZE_KEY = 'kova:install-method-toast-snooze-until'
...
function completedAfterRestart(
  ...
  return !!actionId && status.lines.some(line => line === `=== kova-update completed ${actionId} ===`)
}
