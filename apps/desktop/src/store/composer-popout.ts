...
const POPOUT_STORAGE_KEY = 'kova.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'kova.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'kova.desktop.composerPopout.position'
