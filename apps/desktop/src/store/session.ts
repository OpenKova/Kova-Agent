import type { ConnectionState } from '@kova/shared'
...
const COMPOSER_MODEL_SOURCE_KEY = 'kova.desktop.composer.model-source'
...
const LAST_ROUTE_KEY = 'kova.desktop.lastRoute'
