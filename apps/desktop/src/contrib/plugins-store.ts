 ...
 * `<kova home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'kova.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'kova.desktop.disabledPlugins.v1'
