/**
 * Live skin sync from the Kova backend.
 *
 * The backend resolves the active skin (built-in or `$KOVA_HOME/skins/*.yaml`)
 ...
 * stomps the user's persisted desktop theme; only a genuine name change (Kova
