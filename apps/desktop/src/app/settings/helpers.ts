...
import type { ConfigFieldSchema, KovaConfigRecord, ToolsetInfo } from '@/types/kova'
...
function commandProviderNames(config: KovaConfigRecord, section: 'tts' | 'stt'): string[] {
