...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <kova home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('kova:open-keybinds'))
    } satisfies PaletteContribution
  }
])
...
const $logsOpen = persistentAtom('kova.desktop.logsOpen', false, Codecs.bool)
