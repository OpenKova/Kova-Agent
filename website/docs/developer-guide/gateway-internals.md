...
- **Explicit target delivery** — the send engine specifying `telegram:-1001234567890`, exposed via the [`kova send` CLI](/guides/pipe-script-output) for shell scripts and via cron `deliver:` targets
