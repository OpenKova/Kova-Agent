...
def build_context_files_prompt(cwd=None, skip_soul=False):
    ...
    project_context = (
        _load_kova_md(cwd_path)       # 1. .hermes.md / KOVA.md (walks to git root)
...
|----------|-------|-------------|-------|
| 1 | `.hermes.md`, `KOVA.md` | CWD up to git root | Kova-native project config |
...
1. `.hermes.md` / `KOVA.md` (walks to git root)
...
- Project context files such as `.hermes.md`, `KOVA.md`, `AGENTS.md`, `CLAUDE.md`, or `.cursorrules` — inject repo-specific working rules.
