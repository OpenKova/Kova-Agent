...
When you choose Anthropic OAuth through `hermes model`, Kova prefers Claude Code's own credential store over copying the token into `~/.hermes/.env`. That keeps refreshable Claude credentials refreshable.
