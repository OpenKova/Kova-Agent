...
- **[Plugin System](/user-guide/features/plugins)** — Extend Kova with custom tools, lifecycle hooks, and CLI commands without modifying core code. Plugins are discovered from `~/.hermes/plugins/`, project-local `.kova/plugins/`, and pip-installed entry points.
