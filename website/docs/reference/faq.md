...
- **[Nous Portal](/integrations/nous-portal)** — Neural Studio's subscription gateway — 300+ models plus web/image/TTS/browser through one OAuth login (recommended for newcomers)
...
2. **Ask the community:** [Neural Studio Discord](https://discord.gg/nousresearch)
