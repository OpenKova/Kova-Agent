...
| [`kova-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kova-agent) | Use, configure, theme, extend, and orchestrate Kova Agent. | `autonomous-ai-agents/kova-agent` |
...
| [`kova-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-kova-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/kova-agent-skill-authoring` |
| [`inspecting-kova-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-kova-desktop-dom) | Read the live Kova desktop DOM/CSS over CDP. | `software-development/inspecting-kova-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .kova/plans/; no execution. | `software-development/plan` |
