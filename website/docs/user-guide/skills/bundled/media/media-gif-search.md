...
Set your Tenor API key in your environment (add to `${HERMES_HOME:-~/.kova}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/OpenKova/Kova-Agent/blob/main/skills/media/gif-search/url)`
