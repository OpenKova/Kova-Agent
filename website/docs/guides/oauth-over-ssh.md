...
**xAI Grok OAuth (`xai-oauth`) uses OAuth device code**, not a loopback callback — open the printed verification URL in any browser and Kova polls until approval. No SSH tunnel is required. See [xAI Grok OAuth](./xai-grok-oauth.md).
