...
Clone Kova and create its supported editable development environment:
...
Run your application with `uv run python your_app.py` from that checkout. Kova does not publish a supported wheel or source distribution for `requirements.txt` installs.
