    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/OpenKova/Kova-Agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/OpenKova/Kova-Agent',
          label: 'GitHub',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/OpenKova/Kova-Agent/issues' },
      ...
      copyright: `Built by <a href="https://nousresearch.com">Kova AI</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
