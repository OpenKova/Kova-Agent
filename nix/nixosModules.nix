  ...
  in {
    options.services.kova-agent = with lib; {
      ...
      environmentFiles = mkOption {
        ...
        description = ''
          ...
          Contents are merged into $KOVA_HOME/.env at activation time.
      ...
      environment = mkOption {
        ...
        default = { };
        description = ''
          Non-secret environment variables. Merged into $KOVA_HOME/.env
    ...
    config = lib.mkIf cfg.enable (lib.mkMerge [
      ...
      (lib.mkIf cfg.addToSystemPackages {
        ...
        environment.variables.KOVA_HOME = "${cfg.stateDir}/.kova";
      })
    ...
    KOVA_CONTAINER_MODE_EOF
          ...
          # Kova reads $KOVA_HOME/.env at startup via load_kova_dotenv(),
