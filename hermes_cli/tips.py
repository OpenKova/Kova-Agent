...
TIPS = [
    ...
    "hermes backup creates a zip backup of your entire Kova home directory.",
    ...
    "Kova loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "Profiles scope Kova state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'hermes dashboard embeds the full Kova TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'hermes import restores a full Kova backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
