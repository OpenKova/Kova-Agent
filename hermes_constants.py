...
def get_hermes_home() -> Path:
    ...
    ``hermes_cli/kanban_db.py``).  See https://github.com/Kova/hermes-agent/issues/18594.
    """
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/Kova/hermes-agent/issues/25821.
    """
