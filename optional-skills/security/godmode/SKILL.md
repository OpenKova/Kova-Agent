...
exec(open(os.path.expanduser(
    os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.kova")), "skills/red-teaming/godmode/scripts/load_godmode.py")
)).read())
...
exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.kova")), "skills/red-teaming/godmode/scripts/parseltongue.py")).read())
...
```python
# Via execute_code
exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.kova")), "skills/red-teaming/godmode/scripts/godmode_race.py")).read())
...
5. **Kova models don't need jailbreaking** — nousresearch/hermes-3-* and kova-4-* are already uncensored. Use them directly for the fastest path.
...
12. **execute_code sandbox has no env vars** — When Kova runs auto_jailbreak via execute_code, the sandbox doesn't inherit the Kova `.env`. Load dotenv explicitly: `import os; from dotenv import load_dotenv; load_dotenv(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.kova")), ".env"))`
