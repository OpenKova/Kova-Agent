...
```bash
GSETUP="python ${HERMES_HOME:-$HOME/.kova}/skills/productivity/google-workspace/scripts/setup.py"
```
...
```bash
GAPI="python ${HERMES_HOME:-$HOME/.kova}/skills/productivity/google-workspace/scripts/google_api.py"
```
