...
hermes mcp serve                      Run Kova as an MCP server
```
...
|---|---|
| Config options | `hermes config edit` · [Configuration docs](https://kova-agent.kova.ai/docs/user-guide/configuration) |
| Tools / toolsets | `hermes tools list` · [Tools reference](https://kova-agent.kova.ai/docs/reference/tools-reference) |
| Skills catalog | `hermes skills browse` · [Skills catalog](https://kova-agent.kova.ai/docs/reference/skills-catalog) |
| Provider setup | `hermes model` · [Providers guide](https://kova-agent.kova.ai/docs/integrations/providers) |
| Env variables | `hermes config env-path` · [Env vars reference](https://kova-agent.kova.ai/docs/reference/environment-variables) |
