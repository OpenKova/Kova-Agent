...
export const es: Translations = {
  ...
  status: {
    ...
    updatingHermes: "Actualizando Kova…",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que Kova no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
