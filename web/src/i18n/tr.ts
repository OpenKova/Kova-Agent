...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateHermes: "Kova'i Güncelle",
    updatingHermes: "Kova güncelleniyor…",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve Kova'in tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
