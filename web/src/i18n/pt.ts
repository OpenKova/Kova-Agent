...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateHermes: "Atualizar Kova",
    updatingHermes: "A atualizar Kova…",
  ...
  env: {
    ...
    customHint: "Variáveis de ambiente arbitrárias armazenadas no seu .env que o Kova não reconhece. Use-as para injetar variáveis de ambiente para skills, servidores MCP ou suas próprias ferramentas.",
