...
export const de: Translations = {
  ...
  status: {
    ...
    updatingHermes: "Kova wird aktualisiert…",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Kova nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
