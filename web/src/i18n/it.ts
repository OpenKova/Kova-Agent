...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateHermes: "Aggiorna Kova",
    updatingHermes: "Aggiornamento di Kova…",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che Kova non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
