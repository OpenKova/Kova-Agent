...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "or XAI_API_KEY). Off by default; enable in `kova tools` → "
            "X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
...
for _kova_name, _kova_name in [
    ("kova-acp", "kova-acp"),
    ("kova-api-server", "kova-api-server"),
    ("kova-cli", "kova-cli"),
    ("kova-cron", "kova-cron"),
    ("kova-telegram", "kova-telegram"),
    ("kova-discord", "kova-discord"),
    ("kova-whatsapp", "kova-whatsapp"),
    ("kova-slack", "kova-slack"),
    ("kova-signal", "kova-signal"),
    ("kova-bluebubbles", "kova-bluebubbles"),
    ("kova-homeassistant", "kova-homeassistant"),
    ("kova-email", "kova-email"),
    ("kova-mattermost", "kova-mattermost"),
    ("kova-matrix", "kova-matrix"),
    ("kova-dingtalk", "kova-dingtalk"),
    ("kova-feishu", "kova-feishu"),
    ("kova-weixin", "kova-weixin"),
    ("kova-qqbot", "kova-qqbot"),
    ("kova-wecom", "kova-wecom"),
    ("kova-wecom-callback", "kova-wecom-callback"),
    ("kova-yuanbao", "kova-yuanbao"),
    ("kova-sms", "kova-sms"),
    ("kova-webhook", "kova-webhook"),
    ("kova-gateway", "kova-gateway"),
]:
...
def resolve_toolset(name: str, visited: Set[str] = None, *, include_registry: bool = True) -> List[str]:
    ...
    if not toolset:
        ...
        if include_registry and name.startswith("kova-"):
