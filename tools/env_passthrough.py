...
def _is_kova_provider_credential(name: str) -> bool:
    ...
    let a skill tunnel a Kova credential into the execute_code child.
    """
    try:
        ...
        return True
    # Dynamically-generated Kova-internal secrets (AUXILIARY_*_API_KEY /
    ...
    if _is_kova_internal_secret(name):
        return True
