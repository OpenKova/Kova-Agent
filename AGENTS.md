...
| `load_config()` | `kova tools`, `kova setup`, most CLI subcommands | `hermes_cli/config.py` — merges `DEFAULT_CONFIG` + user YAML |
...
- **CLI:** `hermes_cli/curator.py` wires `kova curator <verb>` where
