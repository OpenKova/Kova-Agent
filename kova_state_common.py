...
Extracted verbatim from kova_state.py so the SessionDB mixin modules
(kova_state_search / kova_state_schema / kova_state_portability) can
reference them without importing kova_state (which would be a cycle).
kova_state re-imports every name here for backward compatibility.
"""
