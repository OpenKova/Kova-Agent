...
def _default_registry_path() -> Path:
    return get_kova_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_kova_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_kova_home = expected_kova_home if expected_kova_home is not None else str(get_kova_home())
